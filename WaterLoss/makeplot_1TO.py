...
for i in range(0,3):
# dSurfaceWater = 1 TO, O2 = 1
         axes[0, 0].plot(bage[i],bSurfWaterMass[i], color=cmap[0], alpha=d[0],lw=b, ls = line[i])
         axes[1, 0].plot(bage[i],bOxygenMantleMass[i], color=cmap[0], alpha=d[0], lw=b, ls = line[i])
         axes[0, 1].plot(bage[i],bPlanetRadius[i], color=cmap[0], alpha=d[0], lw=b, ls = line[i])
         axes[1, 1].plot(bage[i],bEnvelopeMass[i], color=cmap[0], alpha=d[0], lw=b, ls = line[i])
         axes[0, 2].plot(bage[i],bOxygenMass[i], color=cmap[0], alpha=d[0], lw=b, ls = line[i])
         axes[1, 2].plot(bage[i],bFXUV[i], color=cmap[0], alpha=d[0], lw=b, ls = line[i])

         axes[0, 0].plot(cage[i],cSurfWaterMass[i], color=cmap[1], alpha=d[0], lw=b, ls = line[i])
         axes[1, 0].plot(cage[i],cOxygenMantleMass[i], color=cmap[1], alpha=d[0],lw=b, ls = line[i])
         axes[0, 1].plot(cage[i],cPlanetRadius[i], color=cmap[1], alpha=d[0],lw=b, ls = line[i])
         axes[1, 1].plot(cage[i],cEnvelopeMass[i], color=cmap[1], alpha=d[0], lw=b, ls = line[i])
         axes[0, 2].plot(cage[i],cOxygenMass[i], color=cmap[1], alpha=d[0], lw=b, ls = line[i])
         axes[1, 2].plot(cage[i],cFXUV[i], color=cmap[1], alpha=d[0], lw=b, ls = line[i])
# dSurfaceWater = 1 TO, O2 = 0 
         axes[0, 0].plot(bage[i+9],bSurfWaterMass[i+9], color=cmap[0], alpha=d[1],lw=b, ls = line[i])
         axes[1, 0].plot(bage[i+9],bOxygenMantleMass[i+9], color=cmap[0], alpha=d[1], lw=b, ls = line[i])
         axes[0, 1].plot(bage[i+9],bPlanetRadius[i+9], color=cmap[0], alpha=d[1], lw=b, ls = line[i])
         axes[1, 1].plot(bage[i+9],bEnvelopeMass[i+9], color=cmap[0], alpha=d[1], lw=b, ls = line[i])
         axes[0, 2].plot(bage[i+9],bOxygenMass[i+9], color=cmap[0], alpha=d[1], lw=b, ls = line[i])
         axes[1, 2].plot(bage[i+9],bFXUV[i+9], color=cmap[0], alpha=d[1], lw=b, ls = line[i])

         axes[0, 0].plot(cage[i+9],cSurfWaterMass[i+9], color=cmap[1], alpha=d[1], lw=b, ls = line[i])
         axes[1, 0].plot(cage[i+9],cOxygenMantleMass[i+9], color=cmap[1], alpha=d[1],lw=b, ls = line[i])
         axes[0, 1].plot(cage[i+9],cPlanetRadius[i+9], color=cmap[1], alpha=d[1],lw=b, ls = line[i])
         axes[1, 1].plot(cage[i+9],cEnvelopeMass[i+9], color=cmap[1], alpha=d[1], lw=b, ls = line[i])
         axes[0, 2].plot(cage[i+9],cOxygenMass[i+9], color=cmap[1], alpha=d[1], lw=b, ls = line[i])
         axes[1, 2].plot(cage[i+9],cFXUV[i+9], color=cmap[1], alpha=d[1], lw=b, ls = line[i])

axes[0, 1].set_title("Surface Water 1 TO", loc="center")
...
# Save figure
if sys.argv[1] == "pdf":
    fig.savefig("LP8909_atmesc_1TO.pdf", bbox_inches="tight", dpi=300)
if sys.argv[1] == "png":
    fig.savefig("LP8909_atmesc_1TO.png", bbox_inches="tight", dpi=300)
